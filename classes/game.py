...
class Person:
    ...
    def choose_action(self):
        ...
        print(bcolours.OKBLUE+bcolours.BOLD+"    ACTION:"+bcolours.ENDC)
    ...
    def choose_item(self):
        i=1
        print("\n"+bcolours.OKBLUE+bcolours.BOLD+"    ITEMS:"+bcolours.ENDC)
    ...
    def get_enemy_stats(self):
        hp_bar=""
        bar_ticks=int((self.hp/self.maxhp)*100/2)
    ...
    def get_stats(self):
        hp_bar=""
        bar_ticks = int((self.hp/self.maxhp)*100/4)
        ...
        mp_bar=""
        mp_ticks = int((self.mp/self.maxmp)*100/10)
